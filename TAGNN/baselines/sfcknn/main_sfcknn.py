...
from TAGNN.baselines.sfcknn.sfcknn  import *
from pathlib import Path

from TAGNN.accuracy_measures import *

#( self, k = 200, sample_size=300, sampling='recent',  similarity = 'cosine', weighting_score = "linear", remind=False, pop_boost=0, extend=False, 
...
class SFCKNN_MAIN:
    ...
    #             preds += 1e-8 * np.random.rand(len(preds)) #Breaking up ties
        ...
        # Intialize accuracy measures.....
        name = "TAGNN_SFCKNN_"+self.dataset+".txt"
